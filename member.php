...
<?php
  ...
  ?>
       <style type="text/css">
           .yunyou-table-hover > tbody > tr:hover {
...
<div id="content">
  ...
  <tr>
    <td align="center"  >      
      ...
      <table width="100%" border="1px" class="yunyou-bgblur yunyou-table-hover" style="background-color: rgba(0,0,0,0.1);" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0">
      <tr>
