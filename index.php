...
<!-- <div class="jumbotron yunyou-bgblur yunyou-background">
  ...
  <hr>
  <p><a class="btn btn-primary btn-lg btn-block" href="./competition/index.php" title="群星回响">报名入口</a></p>
</div> -->
...
<hr>
<div class="text-center">
	<span class="label label-info">Fantasy Star Web 2.0</span> : 
	<a href="http://association.yunyoujun.cn" target="_blank" class="label label-primary">新版网站线上测试地址</a>
</div>
